      ...
      <Row justify="space-between">
        <Col xs={24} md={10}>
          ...
          <Paragraph style={{ color: "white" }}>
            Empowering parents and caregivers with reliable health insights to
            track their child's growth, monitor developmental milestones, and
            ensure a healthy future through expert guidance and scientifically
            backed resources.{" "}
          </Paragraph>
        </Col>
        <Col xs={24} md={1}>
        ...
        <Col xs={24} md={6}>
          ...
          <Paragraph>
            ...
            <br />
            <Link href="/growth-chart" className="footer-link">
              Growth Chart
            </Link>
            <br />
