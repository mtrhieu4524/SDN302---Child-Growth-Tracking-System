...
const About = () => {
  ...
  return (
    <div style={{ background: "#f9f9f9" }}>
      <Header />
      <br></br><br></br>
      <div style={{ background: "#f9f9f9", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <Content
          style={{
            maxWidth: "80%",
            marginLeft: "-8px",
          ...
          <Paragraph
            ...
            Child Growth Tracking is dedicated to helping parents and caregivers
            monitor and understand their child's physical development.
          </Paragraph>
          ...
          <Row gutter={[24, 24]}>
            <Col xs={24} md={8}>
              <Card
                ...
                <Paragraph style={{ color: "white" }}>
                  Our platform provides tools to track your child's height,
                  weight, and other key health indicators.
                </Paragraph>
              </Card>
            </Col>
            <Col xs={24} md={8}>
              <Card
                ...
                <Paragraph style={{ color: "white" }}>
                  Get expert-backed insights based on your child's growth patterns
            ...
            <Col xs={24} md={8}>
              <Card
                ...
                <Paragraph style={{ color: "white" }}>
                  Access reliable health and nutrition advice to support your
          ...
          <Title level={3} style={{ color: "#0082C8" }}>
            How It Works
          </Title>
          <Paragraph>
          ...
          <Link href="#" style={{ fontSize: "14px", color: "#0082C8" }}>
          ...
          <Row gutter={24}>
            ...
            <Col xs={24} md={18}>
              ...
              <Paragraph>
                ...
                Geriatrics. He is co-host of the GeriPal podcast, a geriatrics and
                palliative care podcast for every healthcare professional.{" "}
                <br></br>- Dr. Smith is co-creator of ePrognosis, an online
                compendium of prognostic indices for use in clinical practice. Dr.
                Smith is heavily engaged in mentoring the next generations of
                aging and palliative care research scholars. <br></br>- Dr. Moyer
                provides executive leadership and strategic direction for the
                center’s statistical programs and policies. Dr. Moyer serves as
                the statistical official for the U.S. Department of Health and
                Human Services (HHS), and senior advisor to the CDC director and
                HHS secretary.{" "}
              </Paragraph>
            </Col>
          </Row>
